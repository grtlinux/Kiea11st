...
function deleteFile(docNo) {
	...
	if (confirm("삭제 하시겠습니까?")) {
		jQuery.ajax({
			type:"POST",
			url:"/SASCampaign/_galleria/mms/delete.do",
			data:"file_seq="+docNo,
			dataType: "json",
		...
		<td colspan="2" bgcolor="#27292D" align="right">
			<table width="100%" border="0" bgcolor="#27292D">
				...
				<tr>
					<td width="20">&nbsp;</td>
					<td align="right">
						<button onclick="return openPopupForAppendPopup('image');" style="background-color:#453A39;border:none;padding:5px">
...
function openPopupForAppendPopup(fileType) {
	window.open('/SASCampaign/_galleria/mms/insert.do?type=' + fileType
			  , "_blank"
