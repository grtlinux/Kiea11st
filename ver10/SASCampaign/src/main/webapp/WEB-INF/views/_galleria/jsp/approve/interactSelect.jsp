...
function runNow(cmpgn_id) {
	if (confirm("실행 하시겠습니까?\n실행 후에는 중지할 수 없습니다.")) {
		var url="/SASCampaign/_galleria/approve/runCamp.do";
...
function openPopupApprove() {
	var url = '/SASCampaign/_galleria/approve/select.do';
...
<form name="frmSearch" action="/SASCampaign/_galleria/approve/main.do">
