...
<!-- KANG-20210316: CHANGE-END -->
<form id="uploadForm" name="uploadForm" method="post" target="_self" enctype="multipart/form-data" action="/SASCampaign/_galleria/file/insertDone.do">
