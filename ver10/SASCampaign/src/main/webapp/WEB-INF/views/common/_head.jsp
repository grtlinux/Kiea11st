	...
	<div id="wrap">
		...
		<div id="top">
			...
			<nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
				...
				<img src="${staticPATH }/image/logo_sub.png" style="padding-left:20px;" > <span style="margin-left:20px;font-size:24px;position: absolute;bottom:0;font-weight:200;">Campaign .</span>
				</a>
				...
				<ul class="nav navbar-top-links navbar-right" style="padding-right:30px;">
					<a href="/SASCampaign/_galleria/main.do">*</a> ${sessionScope.sessionVo.userId} 님이 로그인 하셨습니다.&nbsp;&nbsp;&nbsp;
