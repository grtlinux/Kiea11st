...
hanwha.approval.DraftWindow.prototype = {
	...
	init : function(pDocElement) {
		...
		this.addParam("saveTempYn",saveTempYn);
	},
	
	/**
	 * 기안자의 사번을 받는다.
	 * @param {String} eDrafter 기안자사번
	 */
	setEDrafter : function(eDrafter) {
		this.eDrafter = eDrafter;
	},
	
	getEDrafter : function() {
		return this.eDrafter;			
	},
